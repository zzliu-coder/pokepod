...
python3 "$SCRIPT_DIR/../tools/test-flash-size-policy.py"
python3 "$SCRIPT_DIR/../tools/test-flash-artifact-validation.py"
python3 "$SCRIPT_DIR/../tools/test-resource-review.py"
python3 "$SCRIPT_DIR/../tools/test-power-diagnostics-contract.py"
python3 "$SCRIPT_DIR/../tools/test-runtime-power-time-usb-contract.py"
python3 "$SCRIPT_DIR/../tools/test-three-stage-power-contract.py"
python3 "$SCRIPT_DIR/../tools/test-scroll-contract.py"
python3 "$SCRIPT_DIR/../tools/test-performance-architecture.py"
python3 "$SCRIPT_DIR/../tools/test-time-audio-motion-contract.py"
python3 "$SCRIPT_DIR/../tools/test-wireless-sync-contract.py"
python3 "$SCRIPT_DIR/../tools/test-link-buffer-policy.py"
python3 "$SCRIPT_DIR/../tools/test-link-manifest-contract.py"
python3 "$SCRIPT_DIR/../tools/test-link-deferred-cleanup.py"
python3 "$SCRIPT_DIR/../tools/test-link-command-atomic.py"
python3 "$SCRIPT_DIR/../tools/test-link-storage-lease-contract.py"
python3 "$SCRIPT_DIR/../tools/test-link-recording-stop.py"
python3 "$SCRIPT_DIR/../tools/test-link-operation-contract.py"
python3 "$SCRIPT_DIR/../tools/test-link-operation-production-contract.py"
python3 "$SCRIPT_DIR/../tools/test-ble-thread-ownership.py"
python3 "$SCRIPT_DIR/../tools/test-link-incoming-transaction-contract.py"
python3 "$SCRIPT_DIR/../tools/test-tencent-network-contract.py"
python3 "$SCRIPT_DIR/../tools/test-capability-wiring.py"
python3 "$SCRIPT_DIR/../tools/test-build-input-fingerprint.py"
python3 "$SCRIPT_DIR/../tools/test-build-portability.py"
