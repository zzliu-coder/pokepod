...
constexpr int16_t kShutdownConfirmLeft = kPurgeConfirmLeft;
constexpr int16_t kShutdownConfirmRight = kPurgeConfirmRight;
constexpr int16_t kShutdownConfirmTop = kPurgeConfirmTop;
constexpr int16_t kShutdownConfirmBottom = kPurgeConfirmBottom;
constexpr int16_t kShutdownConfirmActionsTop = kPurgeConfirmActionsTop;
constexpr int16_t kShutdownConfirmActionSplit = kPurgeConfirmActionSplit;
